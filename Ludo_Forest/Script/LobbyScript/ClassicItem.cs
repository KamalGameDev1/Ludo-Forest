...
namespace LudoMGP
{
    public class ClassicItem : MonoBehaviour
    {
        ...
        public Image gameVariantImage;
        public Image maxplayerCountImage;
       
        public void CallItemTable()
        {
            LudoModesTableList.instance.classicTable.SetActive(true);
            LudoModesTableList.instance.timerTable.SetActive(false);
            LudoModesTableList.instance.CallTableApiData(TableId);

            Debug.Log("Classic Table Called");
        }
